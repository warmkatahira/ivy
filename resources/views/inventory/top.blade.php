...
<x-app-layout>
    ...
    <div class="mx-5">
        <div class="grid grid-cols-12 xl:gap-4">
            ...
            <p class="xl:hidden col-span-5">棚卸差分</p>
            <p class="xl:hidden col-start-8 col-span-5">当日累計</p>
            ...
            <div id="inventory_quantity_difference" class="text-white bg-red-500 xl:h-40 text-base xl:text-7xl text-center h-8 py-1 xl:p-10 col-span-5 xl:col-span-2"></div>
            <label for="today_inventory_quantity" class="py-2 xl:py-0 text-base xl:text-xl col-span-12 xl:col-span-1 hidden xl:block text-right">当日累計</label>
            <div id="today_inventory_quantity" class="bg-emerald-300 xl:h-40 text-base xl:text-7xl text-center h-8 py-1 xl:p-10 col-span-5 xl:col-span-2 col-start-8 xl:col-start-11"></div>
        ...
        <div class="mt-3">
            <div class="grid grid-cols-12 xl:gap-4 mb-5">
                <label for="individual_jan_code" class="py-1 text-base xl:text-xl col-span-12 xl:col-span-1">JAN</label>
                ...
                <label for="brand_name" class="py-1 text-base xl:text-base col-span-12 xl:col-span-1">ブランド名</label>
                <div id="brand_name" class="text-xs xl:text-xl bg-indigo-200 h-8 py-2 xl:h-10 xl:py-2 col-span-12 xl:col-span-8"></div>
                <label for="item_name_1" class="py-1 text-base xl:text-xl col-span-12 xl:col-span-1">商品名1</label>
                ...
                <label for="item_name_2" class="py-1 text-base xl:text-xl col-span-12 xl:col-span-1">商品名2</label>
