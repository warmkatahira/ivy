    ...
    <div class="mx-5 mb-5">
        <form method="post" action="{{ route('item_maintenance.individual_modify') }}" class="m-0">
            ...
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                ...
                <input type="text" id="integrate_jan_code" name="integrate_jan_code" value="{{ old('integrate_jan_code', $item->integrate_jan_code) }}" class="col-span-7 xl:col-span-2">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                ...
                <input type="text" id="individual_jan_code" name="individual_jan_code" value="{{ old('individual_jan_code', $item->individual_jan_code) }}" class="col-span-7 xl:col-span-2">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="brand_name" class="col-span-5 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>ブランド名</label>
                <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name', $item->brand_name) }}" class="col-span-7 xl:col-span-10">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                ...
                <input type="text" id="item_name_1" name="item_name_1" value="{{ old('item_name_1', $item->item_name_1) }}" class="col-span-7 xl:col-span-10">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="item_name_2" class="col-span-5 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>商品名2</label>
                <input type="text" id="item_name_2" name="item_name_2" value="{{ old('item_name_2', $item->item_name_2) }}" class="col-span-7 xl:col-span-10">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="jan_start_position" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>JAN開始位置</label>
                <input type="text" id="jan_start_position" name="jan_start_position" class="col-span-3 xl:col-span-1" value="{{ old('jan_start_position', $item->jan_start_position) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="exp_start_position" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>EXP開始位置</label>
                <input type="text" id="exp_start_position" name="exp_start_position" class="col-span-3 xl:col-span-1" value="{{ old('exp_start_position', $item->exp_start_position) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="lot_start_position" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>LOT開始位置</label>
                <input type="text" id="lot_start_position" name="lot_start_position" class="col-span-3 xl:col-span-1" value="{{ old('lot_start_position', $item->lot_start_position) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="lot_length" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>LOT桁数</label>
                <input type="text" id="lot_length" name="lot_length" class="col-span-3 xl:col-span-1" value="{{ old('lot_length', $item->lot_length) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="s_power_code" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>S-POWERコード</label>
                <input type="text" id="s_power_code" name="s_power_code" class="col-span-3 xl:col-span-1" value="{{ old('s_power_code', $item->s_power_code) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="s_power_code_start_position" class="col-span-9 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>S-POWERコード開始位置</label>
                <input type="text" id="s_power_code_start_position" name="s_power_code_start_position" class="col-span-3 xl:col-span-1" value="{{ old('s_power_code_start_position', $item->s_power_code_start_position) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                <label for="location" class="col-span-6 xl:col-span-2 p-2"><i class="las la-pen la-lg"></i>ロケーション</label>
                <input type="text" id="location" name="location" class="col-span-6 xl:col-span-2" value="{{ old('location', $item->location) }}">
            </div>
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
            ...
            <div class="grid grid-cols-12 gap-4 mb-5 border-b-2 border-gray-400 p-5">
                ...
                <input type="text" id="logical_stock" name="logical_stock" class="col-span-6 xl:col-span-1" value="{{ old('logical_stock', $item->logical_stock) }}">
            </div>
